...
import com.test.signatureGenerator.model.GenerateSignatureTokenRequest;
 ...
 */
@Controller
public class GenerateSignatureTokenController {

    @PostMapping("/dynamic/generateSignatureToken")
    public ResponseEntity generateSignature(@RequestBody GenerateSignatureTokenRequest request){

        String signature = null;

        try {

            String stringToSign = new StringBuilder().append(request.getClientId()).append("|").append(request.getTimestamp()).toString();
